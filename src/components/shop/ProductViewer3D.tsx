      ...
      <AnimatePresence>
        {showSwipeHint && (
          <motion.div
            ...
            className="absolute top-20 left-1/2 -translate-x-1/2 bg-black/70 backdrop-blur-md border border-white/10 rounded-full px-4 py-2 text-[8px] font-mono tracking-widest text-[#C9A962] uppercase z-30 flex items-center gap-2"
          >
