...
export const MOCK_OUTFITS: AIOutfit[] = [
  {
    ...
    confidence: 94,
    items: [
      { productId: "00000000-0000-4000-a000-000000000001", role: "top" },
      { productId: "00000000-0000-4000-a000-000000000004", role: "outerwear" },
      { productId: "00000000-0000-4000-a000-000000000002", role: "footwear" },
      { productId: "00000000-0000-4000-a000-000000000003", role: "watch" },
    ],
    totalPrice: 29697,
    fashionScore: 96,
    colorHarmony: 92,
  ...
  },
  {
    ...
    confidence: 91,
    items: [
      { productId: "00000000-0000-4000-a000-000000000004", role: "top" },
      { productId: "00000000-0000-4000-a000-000000000002", role: "footwear" },
      { productId: "00000000-0000-4000-a000-000000000005", role: "accessory" },
    ],
    totalPrice: 18197,
    fashionScore: 89,
    colorHarmony: 85,
