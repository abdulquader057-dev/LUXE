...
const languages: Record<LanguageCode, LanguageData> = {
  ...
  hi: {
    ...
    translations: {
      ...
      "chat.online": "सिस्टम सिंक ऑनलाइन",
  ...
  ur: {
    ...
    translations: {
      ...
      "bot.settings": "ترتیبات",
      "nav.editorial": "ادارتی",
